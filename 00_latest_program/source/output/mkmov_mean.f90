...
!      integer(HID_T) :: dset_qtens
     ...
     ! call update_both_ghosts(n1,n2,vx_me,kstart,kend)
      ...
      do kc=kstart,kend
        do jc=1,n2m
          do ic=1,n1m
           vz_mea(ic,jc,kc)=vz_me(ic,jc,kc)/(1+nstatsamples)
           vy_mea(ic,jc,kc)=vy_me(ic,jc,kc)/(1+nstatsamples)
           vx_mea(ic,jc,kc)=vx_me(ic,jc,kc)/(1+nstatsamples)
           temp_mea(ic,jc,kc)=temp_me(ic,jc,kc)/(1+nstatsamples)
          end do
        end do
      end do
      ...
      filnam1='movie/tem'//ipfi//'.h5'
      filnamxdm = 'movie/tem'//ipfi//'.xmf' 
     ...
     & n3m,n2m,n1m
      write(45,'("tem",i5.5,".h5:/T_me")') itime
      write(45,'("</DataItem>")')
      write(45,'("</Attribute>")')
     ...
     & NumberType=""Float"" Precision=""4"" Format=""HDF"">")')&
     & n3m,n2m,n1m
      write(45,'("tem",i5.5,".h5:/VZ_me")') itime
      write(45,'("</DataItem>")')
      write(45,'("</Attribute>")')
     ...
     & NumberType=""Float"" Precision=""4"" Format=""HDF"">")')&
     & n3m,n2m,n1m
      write(45,'("tem",i5.5,".h5:/VY_me")') itime
      write(45,'("</DataItem>")')
      write(45,'("</Attribute>")')
     ...
     & NumberType=""Float"" Precision=""4"" Format=""HDF"">")')&
     & n3m,n2m,n1m
      write(45,'("tem",i5.5,".h5:/VX_me")') itime
      write(45,'("</DataItem>")')
      write(45,'("</Attribute>")')
