...
!    differemtiation of sec. derivative at 1+1/2 
      ...
      a33m= +a33/g3rc(kc)
      ap3sk(kc)=a33p
      am3sk(kc)=a33m*2.d0*dble(ubcbot)
      ac3sk(kc)=-(ap3sk(kc)+am3sk(kc))
      ap3ssk(kc)=a33p
      am3ssk(kc)=a33m*2.d0*dble(ubcbot)
...
!    differentiation of sec. derivative at n3-1/2   
      ...
      a33p= +a33/g3rc(kp)
      a33m= +a33/g3rc(kc)
      ap3sk(kc)=a33p*2.d0*dble(ubctop)
      am3sk(kc)=a33m
      ac3sk(kc)=-(am3sk(kc)+ap3sk(kc))
      ap3ssk(kc)=a33p*2.d0*dble(ubctop)
      am3ssk(kc)=a33m
      ac3ssk(kc)=-(am3ssk(kc)+ap3ssk(kc))
